...
namespace WindowsGSM.Plugins
{
    public class LastOasis : SteamCMDAgent
    {
        ...
        public string FullName = "LastOasis Season 5 Dedicated Server"; // Game server FullName
        ...
        public string Defaultmap = "DarkOasis Season 5"; // Default map name
        public string Maxplayers = "40"; // Default maxplayers
        public string Additional = "-CustomerKey=b1hcoHLqIIoOfdqn -ProviderKey=K8rWfKpT9cYSL0AK"; // Additional server start parameter
